...
const EVENTS = [
  ...
  },
  {
    seq: '06',
    type: 'milestone',
    title: 'NEXUS v1.0 — Live',
    description: 'Central hub launched. All three projects showcased. Infrastructure dashboard, timeline, and contact sections live. The ecosystem is now publicly visible.',
    tag: 'NEXUS',
    project: 'NEXUS',
  },
  {
    ...
    description: 'Self-hosted infrastructure brought online. NEXUS infrastructure section connected to live data: service status, uptime, resource usage, and network metrics.',
    tag: 'Infrastructure',
    project: 'Infra',
  },
  {
    seq: '08',
    type: 'planned',
    title: 'Project Links Go Live',
    description: 'DeckForge, Cipher, and WatchMatch links activated in the NEXUS projects section as each reaches public deployment readiness.',
    tag: 'Ecosystem',
    project: 'All',
  },
];
